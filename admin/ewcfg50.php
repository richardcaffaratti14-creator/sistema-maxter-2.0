...
$Config_NombreCliente = "Maxter Producciones";
include("../configuration.php");
include("phpdb-core-1.4.php");
...
define("EW_CONN_USER", DB_USER, TRUE);
define("EW_CONN_PASS", DB_PASS, TRUE);
define("EW_CONN_DB", DB_NAME, TRUE);
...
define("EW_PROJECT_NAME", "siteadmin", TRUE); // Project Name
define("EW_RANDOM_KEY", 'pFhs4$#oPO8yUEkc', TRUE); // Random key for encryption
...
include 'ewdynamic.php';


// User level definition table/field names

define("EW_USER_LEVEL_TABLE", "`usuarioslevels`", TRUE);
...
define("EW_USER_LEVEL_PRIV_TABLE", "`usuarioslevelpermissions`", TRUE);
...
define("EW_SENDER_EMAIL", "noreply@siteadmin.com", TRUE); // Sender email
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,bmp,png,doc,xls,pdf,zip,flv", TRUE); // Allowed file extensions
define("EW_MAX_FILE_SIZE", 500000000, TRUE); // Max file size
...
define("EW_UPLOAD_TMP_PATH", "", TRUE); // Upload temp path (relative to app root)
