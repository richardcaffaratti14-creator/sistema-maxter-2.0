...
// PHPMaker 5 configuration for Table formato_video
$formato_video = new cformato_video; // Initialize table object

// Define table class
class cformato_video {
	...
	function cformato_video() {
		$this->TableVar = "formato_video";
		$this->TableName = "formato_video";
		$this->SelectLimit = TRUE;
		$this->id = new cField('formato_video', 'x_id', 'id', "`id`", 3, -1, FALSE);
		$this->fields['id'] =& $this->id;
		$this->nombre = new cField('formato_video', 'x_nombre', 'nombre', "`nombre`", 200, -1, FALSE);
		$this->fields['nombre'] =& $this->nombre;
		$this->precio = new cField('formato_video', 'x_precio', 'precio', "`precio`", 4, -1, FALSE);
		$this->fields['precio'] =& $this->precio;
		$this->carpeta = new cField('formato_video', 'x_carpeta', 'carpeta', "`carpeta`", 200, -1, FALSE);
		$this->fields['carpeta'] =& $this->carpeta;
		$this->orden = new cField('formato_video', 'x_orden', 'orden', "`orden`", 3, -1, FALSE);
		$this->fields['orden'] =& $this->orden;
		$this->Sufijo = new cField('formato_video', 'x_Sufijo', 'Sufijo', "`Sufijo`", 200, -1, FALSE);
	...
	function SqlSelect() { // Select
		return "SELECT * FROM `formato_video`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `formato_video` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		$SQL = "UPDATE `formato_video` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `formato_video` WHERE ";
	...
	// View url
	function ViewUrl() {
		return $this->KeyUrl("formato_videoview.php");
	}

	// Edit url
	function EditUrl() {
		return $this->KeyUrl("formato_videoedit.php");
	}

	// Inline edit url
	function InlineEditUrl() {
		return $this->KeyUrl("formato_videolist.php", "a=edit");
	}

	// Copy url
	function CopyUrl() {
		return $this->KeyUrl("formato_videoadd.php");
	}

	// Inline copy url
	function InlineCopyUrl() {
		return $this->KeyUrl("formato_videolist.php", "a=copy");
	}

	// Delete url
	function DeleteUrl() {
		return $this->KeyUrl("formato_videodelete.php");
	}
