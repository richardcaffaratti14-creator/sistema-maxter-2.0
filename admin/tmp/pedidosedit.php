...
<input type="text" name="x_telefono" id="x_telefono" title="" size="30" maxlength="80" value="<?php echo $pedidos->telefono->EditValue ?>"<?php echo $pedidos->telefono->EditAttributes() ?>>
	...
	<tr class="ewTableAltRow">
		<td class="ewTableHeader">pedido</td>
		<td<?php echo $pedidos->pedido->CellAttributes() ?>><span id="cb_x_pedido">
<textarea name="x_pedido" id="x_pedido" cols="35" rows="4"<?php echo $pedidos->pedido->EditAttributes() ?>><?php echo $pedidos->pedido->EditValue ?></textarea>
</span></td>
	</tr>
	<tr class="ewTableRow">
		<td class="ewTableHeader">extra</td>
		<td<?php echo $pedidos->extra->CellAttributes() ?>><span id="cb_x_extra">
<textarea name="x_extra" id="x_extra" cols="35" rows="4"<?php echo $pedidos->extra->EditAttributes() ?>><?php echo $pedidos->extra->EditValue ?></textarea>
</span></td>
	</tr>
	<tr class="ewTableAltRow">
		<td class="ewTableHeader">id Presupuesto</td>
		<td<?php echo $pedidos->idPresupuesto->CellAttributes() ?>><span id="cb_x_idPresupuesto">
<input type="text" name="x_idPresupuesto" id="x_idPresupuesto" title="" size="30" value="<?php echo $pedidos->idPresupuesto->EditValue ?>"<?php echo $pedidos->idPresupuesto->EditAttributes() ?>>
	...
	<tr class="ewTableRow">
		...
		<td<?php echo $pedidos->sena->CellAttributes() ?>><span id="cb_x_sena">
...
function EditRow() {
	...
	if ($rs->EOF) {
		...
		// Field pedido
		$pedidos->pedido->SetDbValueDef($pedidos->pedido->CurrentValue, NULL);
		$rsnew['pedido'] =& $pedidos->pedido->DbValue;

		// Field extra
		$pedidos->extra->SetDbValueDef($pedidos->extra->CurrentValue, NULL);
		$rsnew['extra'] =& $pedidos->extra->DbValue;

		// Field idPresupuesto
		$pedidos->idPresupuesto->SetDbValueDef($pedidos->idPresupuesto->CurrentValue, NULL);
		$rsnew['idPresupuesto'] =& $pedidos->idPresupuesto->DbValue;

		// Field sena
		$pedidos->sena->SetDbValueDef($pedidos->sena->CurrentValue, NULL);
		$rsnew['sena'] =& $pedidos->sena->DbValue;
