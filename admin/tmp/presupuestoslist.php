...
Pago
<?php } else { ?>
	<a href="presupuestoslist.php?order=<?php echo urlencode('presu_tarjeta') ?>&ordertype=<?php echo $presupuestos->presu_tarjeta->ReverseSort() ?>">Pago<?php if ($presupuestos->presu_tarjeta->getSort() == "ASC") { ?><img src="images/sortup.gif" width="11" height="9" border="0"><?php } elseif ($presupuestos->presu_tarjeta->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="11" height="9" border="0"><?php } ?></a>
<?php } ?>
		</td>
<?php if ($presupuestos->Export == "") { ?>
...
<div class="button-edit"><a href="<?php echo $presupuestos->EditUrl() ?>">Editar</a></div>
</span></td>
<?php } ?>
<?php if ($Security->CanDelete()) { ?>
<td nowrap width="1" style="padding:0"><span class="phpmaker">
