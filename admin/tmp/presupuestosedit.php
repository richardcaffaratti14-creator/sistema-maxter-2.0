...
<input type="text" name="x_sena" id="x_sena" title="" size="30" value="<?php echo $presupuestos->sena->EditValue ?>"<?php echo $presupuestos->sena->EditAttributes() ?>>
</span></td>
	</tr>
	<tr class="ewTableRow">
		<td class="ewTableHeader">Estado</td>
		<td<?php echo $presupuestos->estado->CellAttributes() ?>><span id="cb_x_estado">
<select id="x_estado" name="x_estado"<?php echo $presupuestos->estado->EditAttributes() ?>>
