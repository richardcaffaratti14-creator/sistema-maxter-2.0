...
<p><span class="phpmaker">Vista TABLA: Pedidos
<br><br>
...
<div<?php echo $pedidos->Evento->ViewAttributes() ?>><?php echo $pedidos->Evento->ViewValue ?></div>
	...
	<tr class="ewTableRow">
		...
		<td<?php echo $pedidos->descripcion->CellAttributes() ?>>
<div<?php echo $pedidos->descripcion->ViewAttributes() ?>><?php echo $pedidos->descripcion->ViewValue ?></div>
</td>
	</tr>
	<tr class="ewTableAltRow">
		<td class="ewTableHeader">pedido</td>
		<td<?php echo $pedidos->pedido->CellAttributes() ?>>
<div<?php echo $pedidos->pedido->ViewAttributes() ?>><?php echo $pedidos->pedido->ViewValue ?></div>
</td>
	</tr>
	<tr class="ewTableRow">
		<td class="ewTableHeader">extra</td>
		<td<?php echo $pedidos->extra->CellAttributes() ?>>
<div<?php echo $pedidos->extra->ViewAttributes() ?>><?php echo $pedidos->extra->ViewValue ?></div>
</td>
	</tr>
	<tr class="ewTableAltRow">
