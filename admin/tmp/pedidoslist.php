...
<div class="button-delete"><a href="" onClick="if (!ew_Selected(document.fpedidoslist)) alert('No se seleccionaron registros'); else {document.fpedidoslist.action='pedidosdelete.php';document.fpedidoslist.encoding='application/x-www-form-urlencoded';document.fpedidoslist.submit();};return false;">Borrar registros seleccionados</a></div>
<?php } ?>
<?php } ?>
...
Pago
<?php } else { ?>
	<a href="pedidoslist.php?order=<?php echo urlencode('ped_tarjeta') ?>&ordertype=<?php echo $pedidos->ped_tarjeta->ReverseSort() ?>">Pago<?php if ($pedidos->ped_tarjeta->getSort() == "ASC") { ?><img src="images/sortup.gif" width="11" height="9" border="0"><?php } elseif ($pedidos->ped_tarjeta->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="11" height="9" border="0"><?php } ?></a>
<?php } ?>
		</td>
		<td valign="top">
<?php if ($pedidos->Export <> "") { ?>
...
id Presupuesto
<?php } else { ?>
	<a href="pedidoslist.php?order=<?php echo urlencode('idPresupuesto') ?>&ordertype=<?php echo $pedidos->idPresupuesto->ReverseSort() ?>">id Presupuesto<?php if ($pedidos->idPresupuesto->getSort() == "ASC") { ?><img src="images/sortup.gif" width="11" height="9" border="0"><?php } elseif ($pedidos->idPresupuesto->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="11" height="9" border="0"><?php } ?></a>
<?php } ?>
		</td>
		<td valign="top">
<?php if ($pedidos->Export <> "") { ?>
sena
<?php } else { ?>
	<a href="pedidoslist.php?order=<?php echo urlencode('sena') ?>&ordertype=<?php echo $pedidos->sena->ReverseSort() ?>">sena<?php if ($pedidos->sena->getSort() == "ASC") { ?><img src="images/sortup.gif" width="11" height="9" border="0"><?php } elseif ($pedidos->sena->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="11" height="9" border="0"><?php } ?></a>
<?php } ?>
		</td>
<?php if ($pedidos->Export == "") { ?>
