...
// PHPMaker 5 configuration for Table accesorios
$accesorios = new caccesorios; // Initialize table object
...
class caccesorios {
	...
	function caccesorios() {
		$this->TableVar = "accesorios";
		$this->TableName = "accesorios";
		$this->SelectLimit = TRUE;
		$this->id = new cField('accesorios', 'x_id', 'id', "`id`", 3, -1, FALSE);
		$this->fields['id'] =& $this->id;
		$this->nombre = new cField('accesorios', 'x_nombre', 'nombre', "`nombre`", 200, -1, FALSE);
		$this->fields['nombre'] =& $this->nombre;
		$this->precio = new cField('accesorios', 'x_precio', 'precio', "`precio`", 131, -1, FALSE);
		$this->fields['precio'] =& $this->precio;
		$this->activo = new cField('accesorios', 'x_activo', 'activo', "`activo`", 16, -1, FALSE);
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `accesorios` ($names) VALUES ($values)";
	}
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `accesorios` WHERE ";
	...
	// View url
	function ViewUrl() {
		return $this->KeyUrl("accesoriosview.php");
	}

	// Edit url
	function EditUrl() {
		return $this->KeyUrl("accesoriosedit.php");
	}

	// Inline edit url
	function InlineEditUrl() {
		return $this->KeyUrl("accesorioslist.php", "a=edit");
	}

	// Copy url
	function CopyUrl() {
		return $this->KeyUrl("accesoriosadd.php");
	}

	// Inline copy url
	function InlineCopyUrl() {
		return $this->KeyUrl("accesorioslist.php", "a=copy");
	}

	// Delete url
	function DeleteUrl() {
		return $this->KeyUrl("accesoriosdelete.php");
	}
